        ...
        <div className="container mx-auto px-4">
            <div className="flex flex-wrap">
                <div className="w-full">
                    <h1 className="text-4xl font-bold mb-4">Membros</h1>
                </div>
            </div>
            <div className="flex flex-wrap">
                <div className="w-full">
                ...
                {membros.map((membro) => (
                    <div className="w-full md:w-1/2 lg:w-1/3 p-4" key={membro.id}>
                        <div className="border p-4 rounded">
                            <div className="mb-4">
                                <h5 className="text-2xl font-bold">{membro.nome}</h5>
                                <p className="text-sm">{membro.idade}</p>
                                <p className="text-sm">{membro.posicao}</p>
                                <p className="text-sm">{membro.descricao}</p>
                                <p className="text-sm">{membro.senha}</p>
                            </div>
